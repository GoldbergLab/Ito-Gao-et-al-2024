...
Note that this is a static snapshot of the code for Ito, Gao et. al. 2024, and it corresponds to the release tagged "v1.0.0" in the original repo, https://github.com/GoldbergLab/tongueSegmentationServer
